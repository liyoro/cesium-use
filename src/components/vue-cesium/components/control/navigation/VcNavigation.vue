  ...
  <div class="vc-navigationContainer" ref="navigationContainer" v-if="canRender">
    <div class="vc-navigation">
      ...
      <div class="vc-navigation-controls">
        ...
        <div class="vc-navigation-control" v-if="defaultOptions.enableMyLocation">
          <vc-my-location
            :enableMyLocation="defaultOptions.enableMyLocation"
    ...
    <div :style="ldStyle" class="vc-location-distance">
      ...
      <vc-distance-legend
        ...
        v-if="defaultOptions.enableDistanceLegend"
      ></vc-distance-legend>
    </div>
  </div>
</template>
    ...
    widgetResized() {
      ...
      if (this.ldBottom === 2) {
        ...
        this.viewer.fullscreenButton &&
          (ldRight += this.viewer.fullscreenButton.container.getBoundingClientRect().width)

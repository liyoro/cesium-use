...
export default {
  ...
  methods: {
    ...
    zoomToMyLocation(position) {
      ...
      defined(this.enableMyLocation.hpr) &&
        Array.isArray(this.enableMyLocation.hpr) &&
        (options.offset = new Cesium.HeadingPitchRange(
          this.enableMyLocation.hpr[0],
          this.enableMyLocation.hpr[1],
          this.enableMyLocation.hpr[2]
        ))

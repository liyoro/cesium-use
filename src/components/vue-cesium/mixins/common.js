        ...
        Object.keys(that.$options.props).forEach(vueProp => {
          ...
          const unwatch = that.$watch(
            ...
            async val => {
              ...
              const pdProto =
                cesiumObject && Object.getOwnPropertyDescriptor(Object.getPrototypeOf(cesiumObject), cesiumProp)
              ...
              if (hasSetter) {
                ...
                if (watcherOptions && watcherOptions.cesiumObjectBuilder) {
                  ...
                  if (
                    !(Cesium.defined(cesiumObject[cesiumProp]) && Cesium.defined(cesiumObject[cesiumProp]._callback))
                  ) {

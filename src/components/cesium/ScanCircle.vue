<!--
 * @Author: liyoro
 * @Date: 2023-06-25 17:55:15
 * @LastEditors: liyoro
 * @LastEditTime: 2023-06-25 22:55:30
 * @Description: 圆形扫描 ScanCircle
-->
<template>
...
<script>
import cmp from 'vue-cesium/lib/mixins/virtualCmp'
import { position, color } from 'vue-cesium/lib/mixins/mixinProps'
export default {
  name: 'scan-circle-1',
  ...
  methods: {
    async createCesiumObject() {
      const { $props, transformProps, Cesium, viewer } = this
